...
c.execute("""INSERT into todo (Example,Meaning,Type,Word) VALUES('At first the hostess tried intimation, praising the benefits of cutlery; when Cecil continued eating with his hands, the hostess told him to use a fork at dinner.','an indirect suggestion','noun','intimation')""")
